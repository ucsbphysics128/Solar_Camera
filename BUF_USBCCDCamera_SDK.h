...
SDK_API BUFCCDUSB_SetPowerSavingMode( int DeviceID, int IsEnableCCD );
...
SDK_API BUFCCDUSB_StartCameraEngine2( HWND ParentHandle, int CameraBitOption, int WorkMode );
SDK_API BUFCCDUSB_StopCameraEngine( void );
SDK_API BUFCCDUSB_GetCameraFirmwareVersion( int DeviceID, int FirmwareType );
...
SDK_POINTER_API BUFCCDUSB_GetCurrentFrame_16Bit( int FrameType, int deviceID, unsigned short* &FrameBuf);
SDK_API BUFCCDUSB_SetUserMark( int deviceID, unsigned char clampLevel );
